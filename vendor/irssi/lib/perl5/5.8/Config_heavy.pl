...
cccdlflags=' '
ccdlflags=' -s'
ccflags='-DPERL_USE_SAFE_PUTENV -fno-strict-aliasing -pipe -Wdeclaration-after-statement'
...
cf_time='Sun Jul  8 19:08:44 GMT 2007'
charsize='1'
chgrp=''
chmod='chmod'
chown=''
...
comm='comm'
compress=''
config_arg0='/usr/src/perl/perl-5.8.8/perl-5.8.8/Configure'
config_arg1='-de'
...
mydomain='.x-ray.at'
myhostname='reini'
myuname='cygwin_nt-5.1 reini 1.5.24(0.15642) 2007-01-31 10:57 i686 cygwin '
n='-n'
need_va_copy='undef'
netdb_hlen_type='int'
...
srand48_r_proto='0'
srandom_r_proto='0'
src='/usr/src/perl/perl-5.8.8/perl-5.8.8'
ssizetype='ssize_t'
startperl='#!/usr/bin/perl5.8.8'
startsh='#!/bin/sh'
...
ccflags_nolargefiles='-DPERL_USE_SAFE_PUTENV -fno-strict-aliasing -pipe -Wdeclaration-after-statement'
