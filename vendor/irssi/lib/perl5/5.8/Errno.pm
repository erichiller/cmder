...
"cygwin-thread-multi-64int-1.5.24(0.15642)" or
	die "Errno architecture (cygwin-thread-multi-64int-1.5.24(0.15642)) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
