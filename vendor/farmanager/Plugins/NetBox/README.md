...
Based on [WinSCP](http://winscp.net/eng/index.php) version 5.7.5 Copyright (c) 2000-2015 Martin Prikryl  
SSH and SCP code based on PuTTY 0.65 Copyright (c) 1997-2015 Simon Tatham  
